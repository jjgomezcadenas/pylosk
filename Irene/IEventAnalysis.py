"""
Extends KEventAnalysis for Irene
"""

from KEventAnalysis import *


class IEventAnalysis(object):
   
    """
    IEventAnalysis extends KEventAnalysis for an IreneReader
    JJ, Spring, 2014
    ...
    def KInitialState(self):
        ...
        It depends of the Hits (KMCParticle)
        and the model (KFitter)
        """
        return
